...
const store = {
  ...
  actions: {
    ...
    getWifiSettings: async ({ state }) => ({ wifiSettings: await backend.getWifiSettings() }),
    ...
    getNeighborData: async ({ state }) => ({ neighborData: await backend.getNeighborData() }),
    getInfo: async () => ({ info: await backend.getInfo() }),
